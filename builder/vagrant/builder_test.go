...
func TestBuilder_Prepare_ValidateSource(t *testing.T) {
	...
	for _, tc := range cases {
		...
		if (err == nil && tc.errExpected == false) || (err != nil && tc.errExpected == true) {
			t.Fatalf("Unexpected behavior from test case %#v; %s", tc.config, tc.reason)
		}
	}
}

// "source_path": "./package.box",
// "add_force": true,
// "provider": "virtualbox",
// "checksum": "97fe54f20ed865e58afc38ee7620602bfc8e223458e409c10a7d68c719ab0791",
